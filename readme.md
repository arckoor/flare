...
The provided [shell.nix](/shell.nix) file sets up all necessary development dependencies, as well as providing a few utility commands.
If you are not using nix, you will need a `postgres` and a `redis` instance.
